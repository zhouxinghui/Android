...
public class TitleBar extends RelativeLayout {
    ...
    private void init(final Context context, AttributeSet attrs) {
        ...
        needBottomLine = typedArray.getBoolean(R.styleable.Title_bar_needBottomLine,false);
        typedArray.recycle();
        ...
        backView.setPadding((int) getResources().getDimension(R.dimen.x12),(int) getResources().getDimension(R.dimen.x5)
                ,(int) getResources().getDimension(R.dimen.x12),(int) getResources().getDimension(R.dimen.x5));
        if(leftImage == null){
