...
import ebag.mobile.bean.ChildNodeBean;
...
public class WheelView extends View {
     ...
     * 设置数据
     */
    private ArrayList<ChildNodeBean> dataList = new ArrayList<>();
    /**
     * 按下的Y坐标
     */
    private int downY;
     ...
     * @param data 数据集
     */
    public void setData(List<ChildNodeBean> data) {
        this.dataList = (ArrayList<ChildNodeBean>) data;
        initData();
    }
     ...
     * @param data 数据集
     */
    public void refreshData(List<ChildNodeBean> data) {
        setData(data);
        findItemsToShow();
        invalidate();
    }
