...
public class Utils {
    ...
    public static String getConnectionScheme() {
        return "vnc";
    }
    
    public static int getDefaultPort() {
        return Constants.DEFAULT_VNC_PORT;
    }
    ...
    public static boolean querySharedPreferenceBoolean(Context context, String key, boolean defaultB) {
        SharedPreferences sp = context.getSharedPreferences(Constants.generalSettingsTag, Context.MODE_PRIVATE);
