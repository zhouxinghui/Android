...
import kotlinx.android.synthetic.main.fragment_base_list_tab.*

/**
 * Created by YZY on 2018/3/30.
 */
abstract class BaseListTabFragment<Parent, E>: BaseFragment(),BaseQuickAdapter.OnItemClickListener,
        BaseQuickAdapter.OnItemChildClickListener {
    override fun getLayoutRes(): Int {
        return R.layout.fragment_base_list_tab
    }

    protected var mAdapter: BaseQuickAdapter<E, BaseViewHolder>? = null
    protected var needFirstLoad = true
    protected abstract fun loadConfig(bundle: Bundle?)
    ...
    open protected fun firstPageDataLoad(result: List<E>){
        if (result.isEmpty()) {
            ...
            viewPager.adapter = SectionsPagerAdapter(childFragmentManager, arrayOfNulls(size))
