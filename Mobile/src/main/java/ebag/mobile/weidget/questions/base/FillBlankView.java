...
import ebag.mobile.weidget.keyboard.KeyBoardView;
...
public class FillBlankView extends FrameLayout {
    ...
    private void initView() {
        ...
        tvContent.setTextSize(TypedValue.COMPLEX_UNIT_PX,getResources().getDimensionPixelSize(R.dimen.tv_normal));
    ...
    private class BlankClickableSpan extends ClickableSpan {
        ...
        public void onClick(final View widget) {
            ...
            mHiddenImage.setOnClickListener(new OnClickListener() {
                @Override
