package ebag.mobile.widget.questions;
...
public class SortHorizontalView extends BaseQuestionView {
    ...
    protected void addBody(Context context) {
        ...
        DividerItemDecoration decoration = new DividerItemDecoration(HORIZONTAL
                ,getResources().getDimensionPixelOffset(R.dimen.x10), Color.parseColor("#00000000"));
        ...
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getResources().getDimensionPixelSize(R.dimen.question_tag_height));
        ...
        layoutParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getResources().getDimensionPixelSize(R.dimen.question_tag_height));
        ...
        LinearLayout.LayoutParams viewParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getResources().getDimensionPixelSize(R.dimen.y1));
