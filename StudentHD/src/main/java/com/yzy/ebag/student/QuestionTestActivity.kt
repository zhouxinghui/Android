...
//        }
    ...
    private fun setMathFractionView(){
        ...
        questionBean.answer = "1,42;2,15;7,24"
...
//        questionBean.answer = "4,2,2,8,3,1,2,1,2"
    ...
    private fun setMathVerticalView2(){
        ...
        questionBean.answer = "1,1,7,3,5,3,2,3,2,1,2"
//        questionBean.answer = "4,2,2,8,3,1,2,1,2"
    ...
    private fun setMathVerticalView(){
        ...
        questionBean.answer = "4,9,2,8,2,1,3,1,2"
//        questionBean.answer = "4,2,2,8,3,1,2,1,2"
    ...
    private fun setSentenceView(){
        ...
        questionBean.studentAnswer = "孔子往东边游学"
    ...
    private fun setConnectionView(){
        ...
        questionBean.answer = "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/question/questionImg/blackboard.jpg,blackboard;" +
...
//                "schoolbag,http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/question/questionImg/schoolbag.jpg"
    ...
    private fun setClassificationView(){
        ...
        questionBean.answer = "介词#R#on,under;学校物品#R#classroom,blackboard;代词#R#she,he;动物#R#elephant,bird"
        questionBean.studentAnswer = ""
    ...
    private fun setEnSort(){
        ...
        questionBean.answer = "Put,your,ruler,in,the,pencil box,."
        questionBean.studentAnswer = "Put,ruler,your,in,the,pencil box,."
    ...
    private fun setJudge(){
        ...
        questionBean.answer = "对"
        questionBean.studentAnswer = "错"
    ...
    private fun setCompletion(){
        ...
        questionBean.studentAnswer = "电视机#R#台灯#R#桌子#R#房间#R#在......后面#R#在......旁边"
...
//        questionBean.rightAnswer = "C"
    ...
    private fun setSortView(){
        ...
        questionBean.answer = "5,2,3,1,4"
        questionBean.studentAnswer = "3,2,4,1,5"
