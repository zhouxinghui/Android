...
class HomeworkReportActivity : BaseActivity(), HomeworkReportContract.HomeworkReportView {
    ...
    private lateinit var isHomeworkTask: String
    ...
    override fun initViews() {
        ...
        isHomeworkTask = intent.getStringExtra("isHomeworkTask")
    ...
    companion object {
        fun start(context: Context, homeworkid: String, endTime: String,type:String,state:String,isHomeworkTask:String = "") {
            context.startActivity(Intent(context, HomeworkReportActivity::class.java).putExtra("homeworkid", homeworkid).putExtra("endTime", endTime).putExtra("type",type).putExtra("state",state).putExtra("isHomeworkTask",isHomeworkTask))
        }
    }
    ...
    override fun <T> showContent(data: T?) {
        ...
        mFragmentList.add(HomeworkAbstractFragment(data as HomeworkAbstractBean, mEndTime,mHomeworkId,isHomeworkTask))
