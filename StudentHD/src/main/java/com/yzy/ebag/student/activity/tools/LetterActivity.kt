...
//                adapter.selectedPosition = position
    ...
    private val zmList by lazy {
        val list = ArrayList<LetterBean>()
        list.add(LetterBean("A a [ei]", "诶", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/a.mp3"))
        list.add(LetterBean("B b [bi:]", "哔", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/b.mp3"))
        list.add(LetterBean("C c [si:]", "司仪", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/c.mp3"))
        list.add(LetterBean("D d [di:]", "低", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/d.mp3"))
        list.add(LetterBean("E e [i:]", "衣", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/e.mp3"))
        list.add(LetterBean("F f [ef]", "爱抚", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/f.mp3"))
        list.add(LetterBean("G g [dʒi:]", "计一", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/g.mp3"))
        list.add(LetterBean("H h [eit∫]", "诶吃", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/h.mp3"))
        list.add(LetterBean("I i [ai]", "唉一", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/i.mp3"))
        list.add(LetterBean("J j [dʒei]", "之诶", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/j.mp3"))
        list.add(LetterBean("K k [kei]", "尅", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/k.mp3"))
        list.add(LetterBean("L l [el]", "爱凹", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/l.mp3"))
        list.add(LetterBean("M m [em]", "爱母", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/m.mp3"))
        list.add(LetterBean("N n [en]", "爱恩", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/n.mp3"))
        list.add(LetterBean("O o [əʊ]", "欧", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/o.mp3"))
        list.add(LetterBean("P p [pi:]", "劈", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/p.mp3"))
        list.add(LetterBean("Q q [kju:]", "棵右", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/q.mp3"))
        list.add(LetterBean("R r [ɑ:]", "啊二", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/r.mp3"))
        list.add(LetterBean("S s [es]", "爱丝", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/s.mp3"))
        list.add(LetterBean("T t [ti:]", "踢", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/t.mp3"))
        list.add(LetterBean("U u [ju:]", "优", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/u.mp3"))
        list.add(LetterBean("V v [vi:]", "威", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/v.mp3"))
        list.add(LetterBean("W w ['dʌblju:]", "答不留", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/w.mp3"))
        list.add(LetterBean("X x [eks]", "爱克丝", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/x.mp3"))
        list.add(LetterBean("Y y [wai]", "外", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/y.mp3"))
        list.add(LetterBean("Z z [zi:]", "紫一", "http://ebag-public-resource.oss-cn-shenzhen.aliyuncs.com/mp3/zm/z.mp3"))
        list
    }
