...
class AddCourseDialog(context: Context): BaseDialog(context) {
    ...
    inner class SubjectAdapter: BaseQuickAdapter<AddCourseTextbookBean.SubjectBean, BaseViewHolder>(R.layout.item_assign_popup){
    ...
    inner class VersionAdapter : BaseQuickAdapter<AddCourseTextbookBean.SubjectBean.BookVersionsBean, BaseViewHolder>(R.layout.item_assign_popup){
        var selectPosition = -1
            set(value) {
                field = value
