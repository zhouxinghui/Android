...
import ebag.mobile.widget.questions.base.LineEditText;
...
public class SentenceView extends BaseQuestionView {
    ...
    protected void addBody(Context context) {
        ...
        lineEditText.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimensionPixelSize(R.dimen.tv_normal));
