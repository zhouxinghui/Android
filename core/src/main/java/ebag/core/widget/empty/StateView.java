 ...
 * to lazily inflate loadingView/emptyView/errorView at runtime.
 *
 * @author Nukc
...
public class StateView extends View {
    ...
    private int mEmptyLayoutResource;
    private int mErrorLayoutResource;
    ...
    public void setEmptyResource(@LayoutRes int emptyResource) {
        this.mEmptyLayoutResource = emptyResource;
    }
    ...
    public void setErrorResource(@LayoutRes int errorResource) {
        this.mErrorLayoutResource = errorResource;
    }
    ...
    public void setLoadingResource(@LayoutRes int loadingResource) {
        mLoadingLayoutResource = loadingResource;
    }
    ...
    /**
     * Listener used to receive a notification after the ErrorView is clicked.
     */
