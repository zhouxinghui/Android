...
public class XRecyclerView extends BetterRecyclerView {
    ...
    public void setFootViewText(String loading, String noMore, String error) {
        if(mFootView instanceof LoadingMoreFooter){
            ((LoadingMoreFooter) mFootView).setLoadingHint(loading);
            ((LoadingMoreFooter) mFootView).setNoMoreHint(noMore);
            ((LoadingMoreFooter) mFootView).setErrorHint(error);
        }
    }
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == RecyclerView.SCROLL_STATE_IDLE && mOnLoadMoreListener != null && !isLoadingData && loadingMoreEnabled) {
            ...
            if (layoutManager.getChildCount() > 0
                    ...
                    && layoutManager.getItemCount() + 2 >= layoutManager.getChildCount()
    ...
    public interface ScrollViewListener {
        ...
        void onScrollChanged(XRecyclerView xRecyclerView, int x, int y, int oldx, int oldy);
    ...
    public void setOnLoadMoreListener(OnLoadMoreListener onLoadMoreListener){
        ...
        if(mFootView instanceof LoadingMoreFooter){
            ((LoadingMoreFooter)mFootView).setOnFooterClickListener(onLoadMoreListener);
        }
    }
