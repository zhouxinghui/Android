...
public class LoadingMoreFooter extends LinearLayout implements View.OnClickListener{
    ...
    public void initView(){
        ...
        errorHint = (String)getContext().getText(R.string.loading_error);
    ...
    public void setOnFooterClickListener(XRecyclerView.OnLoadMoreListener onLoadMoreListener){
        this.mOnLoadMoreListener = onLoadMoreListener;
    }

    @Override
    public void onClick(View v) {
        if(this.state == STATE_ERROR && mOnLoadMoreListener != null)
