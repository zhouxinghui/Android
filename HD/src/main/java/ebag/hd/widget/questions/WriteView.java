...
import ebag.core.xRecyclerView.adapter.OnRVItemLongClickListener;
...
public class WriteView extends LinearLayout implements IQuestionEvent {
    ...
    protected void onFinishInflate() {
        ...
        adapter = new MyAdapter(recyclerView, itemLayoutRes);
...
//                if (bitmap != null)
        ...
        adapter.setOnRVItemLongClickListener(new OnRVItemLongClickListener() {
            @Override
            public boolean onRVItemLongClick(ViewGroup recyclerView, View view, int position) {
    ...
    private class MyAdapter extends RecyclerAdapter<File>{
        ...
        public MyAdapter(RecyclerView recyclerView, int layoutRes) {
            super(recyclerView, layoutRes);
        }

        @Override
        protected void fillData(ViewHolderHelper setter, int position, File entity) {
