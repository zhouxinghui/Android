...
public class NormalWheelView extends View {
    ...
    public NormalWheelView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
        initData();
    }

    public NormalWheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
        initData();
    }

    public NormalWheelView(Context context) {
        super(context);
        initData();
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        selectedColor = attribute.getColor(R.styleable.WheelView_selectTextColor, selectedColor);
    ...
    private void onEndSelecting(final ItemObject toShowItem) {
        if (onSelectListener != null) {
            callbackHandler.post(new Runnable() {
                @Override
                public void run() {
                    onSelectListener.endSelect(NormalWheelView.this, toShowItem.id, toShowItem.getItemText());
                }
            });
        }
    }
