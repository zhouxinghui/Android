package com.yun.vnc.bVNC.input;

import android.os.Handler;
import android.view.KeyEvent;

import com.yun.vnc.bVNC.MetaKeyBean;
import com.yun.vnc.bVNC.RemoteCanvas;
import com.yun.vnc.bVNC.RfbConnectable;
import com.yun.vnc.bVNC.UnicodeToKeysym;
...
public class RemoteVncKeyboard extends RemoteKeyboard {
    ...
    public RemoteVncKeyboard (RfbConnectable r, RemoteCanvas v, Handler h, boolean rAltAsIsoL3Shift) {
        ...
        if (rAltAsIsoL3Shift)
            RemoteVncKeyboard.rAltAsIsoL3Shift = true;
    }
