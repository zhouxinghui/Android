...
public class MultiUploadRequestBody extends RequestBody {
    ...
    MultiUploadRequestBody(ByteString boundary, MediaType type, List<Part> parts, OnUploadListener onUploadListener) {
    ...
    public static final class Builder {
        ...
        public MultiUploadRequestBody build() {
            if (parts.isEmpty()) {
                throw new IllegalStateException("Multipart body must have at least one part.");
            }
            return new MultiUploadRequestBody(boundary, type, parts,onUploadListener);
        }
    }
}
