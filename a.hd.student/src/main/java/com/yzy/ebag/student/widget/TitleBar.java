package com.yzy.ebag.student.widget;
...
public class TitleBar extends RelativeLayout {
    ...
    private void init(final Context context, AttributeSet attrs) {
        ...
        titleParams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, (int) getResources().getDimension(R.dimen.x48));
        ...
        leftParams = new RelativeLayout.LayoutParams((int) getResources().getDimension(R.dimen.x45), (int) getResources().getDimension(R.dimen.x48));
        ...
        if(needBottomLine){
            ...
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,dip2px(context,0.5f));
    ...
    private void addRight(boolean isText){
        if(isText)
            rightParams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, (int) getResources().getDimension(R.dimen.x48));
        else
            rightParams = new RelativeLayout.LayoutParams((int) getResources().getDimension(R.dimen.x45), (int) getResources().getDimension(R.dimen.x48));
