...
public class RecorderView extends BaseQuestionView {
    ...
    protected void addBody(Context context) {
        ...
        params = new LinearLayout.LayoutParams(getResources().getDimensionPixelSize(R.dimen.x40),
                getResources().getDimensionPixelSize(R.dimen.x40));
        ...
        params = new LinearLayout.LayoutParams(getResources().getDimensionPixelSize(R.dimen.x30),
                getResources().getDimensionPixelSize(R.dimen.x30));
        params.leftMargin = getResources().getDimensionPixelSize(R.dimen.x15);
