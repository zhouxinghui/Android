...
import ebag.mobile.bean.CurrentCityBean
...
//            setResult(Constants.CREATE_CLASS_RESULT)
    ...
    override fun initViews() {
        ...
        currentCityBean = SerializableUtils.getSerializable<CurrentCityBean>(ebag.mobile.base.Constants.CURRENT_CITY)
        /*if (currentCityBean != null) {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == ebag.mobile.base.Constants.SELECT_SCHOOL
                && resultCode == ebag.mobile.base.Constants.BACK_TO_CREATE_CLASS && data != null){
            currentCityBean = data.getSerializableExtra(ebag.mobile.base.Constants.CURRENT_CITY) as CurrentCityBean
            schoolName.text = currentCityBean?.schoolName
            schoolName.isSelected = true
        }
    }
