...
public abstract class AbstractConnectionBean extends IdImplementationBase implements IConnectionBean {
    ...
    public static final int GEN_COUNT = 19;
    ...
    public static final int GEN_ID_VIEWONLY = 18;
    ...
    public int[] Gen_columnIndices(android.database.Cursor cursor) {
        ...
        result[6] = cursor.getColumnIndex(GEN_FIELD_PREFENCODING);
        result[7] = cursor.getColumnIndex(GEN_FIELD_EXTRAKEYSTOGGLETYPE);
        result[8] = cursor.getColumnIndex(GEN_FIELD_FORCEFULL);
        result[9] = cursor.getColumnIndex(GEN_FIELD_INPUTMODE);
        result[10] = cursor.getColumnIndex(GEN_FIELD_SCALEMODE);
        result[11] = cursor.getColumnIndex(GEN_FIELD_USEDPADASARROWS);
        result[12] = cursor.getColumnIndex(GEN_FIELD_USELOCALCURSOR);
        result[13] = cursor.getColumnIndex(GEN_FIELD_KEEPPASSWORD);
        ...
        result[18] = cursor.getColumnIndex(GEN_FIELD_VIEWONLY);
        return result;
    }
