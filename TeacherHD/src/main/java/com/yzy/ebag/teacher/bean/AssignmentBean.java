...
public class AssignmentBean implements Serializable {
    ...
    private List<AssignGradeBean> sendHomePageClazzInfoVos;
    private List<QuestionsBean> resultAdvertisementVos;
    ...
    public List<AssignGradeBean> getSendHomePageClazzInfoVos() {
        return sendHomePageClazzInfoVos;
    }

    public void setSendHomePageClazzInfoVos(List<AssignGradeBean> sendHomePageClazzInfoVos) {
        this.sendHomePageClazzInfoVos = sendHomePageClazzInfoVos;
    }

    public List<QuestionsBean> getResultAdvertisementVos() {
        return resultAdvertisementVos;
    }

    public void setResultAdvertisementVos(List<QuestionsBean> resultAdvertisementVos) {
