...
import ebag.mobile.widget.questions.base.MathView;
...
public class MathFractionView extends BaseQuestionView {
    ...
    protected void addBody(Context context) {
        ...
        addView(recyclerView,new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT));
    }
